...
echo "Create Stack"
aws cloudformation create-stack --stack-name $stackname  --template-body file://cloudform.yaml --parameters ParameterKey=BucketName,ParameterValue=$bucketname | xargs
